...
**Pending next action:** publication is done and verified; continue authorized preparation stages 02 to 07 with sequential checks, starting with Stage 02 cycle-label standardization. A10 modeling remains separate. Continue the PDS-first user-side source search; no dbGaP application. Affiliation and Downloads duplicate housekeeping remain unanswered/unverified.
